...
public class ArraysReview {
    public static void main(String[] args) {
        //First, declare and initialize a 4x3 2D array of doubles called `scores` which will contain the
        // exam data for four students. The rows will represent the student and the columns will represent
        // the exam number. You already know the first exam scores (80.4, 96.2, 100.0, 78.9).
        ...
        //The next set of exams have occurred.
        // Using 4 lines of code,we manually enter the scores (89.7, 90.5, 93.6, 88.1) for the second exam (column 1).
        // print statement to print the updated 2D array as well.
        scores[0][1] = 89.7;
        scores[1][1] = 90.5;
        scores[2][1] = 93.6;
        scores[3][1] = 88.1;
        ...
        //the students to complete an extra credit activity to contribute towards their scores.
