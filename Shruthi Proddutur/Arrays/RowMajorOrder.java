...
public class RowMajorOrder {
    public static void main(String[] args) {
        ...
        // using the iterators 'outer' and 'inner' for the outer and inner loops
        ...
        for(int outer = 0; outer < times.length; outer++) {
            ...
            for(int inner = 0; inner < times[outer].length; inner++) {
                ...
                // summing up the values in each row. Use the variable runnerTime
                runnerTime += times[outer][inner];

            }
            // finding the average time of each runner. Use the variable averageVal
            double averageVal = 0;
